package com.example.interest1.ui.screens.single_chat
...
import com.example.interest1.ui.message_recycler_view.views.AppViewFactory
...
class SingleChatFragment(private val contact: CommonModel) : BaseFragment(R.layout.fragment_single_chat) {
    ...
    private fun initFields() {
        ...
        chat_input_message.addTextChangedListener(AppTextWatcher{
            ...
            if (string.isEmpty()||string == "Зaпись"){
            ...
            chat_btn_voice.setOnTouchListener { v, event ->
                if (checkPermission(RECORD_AUDIO)){
                    if (event.action == MotionEvent.ACTION_DOWN){
                        //record
                        chat_input_message.setText("Зaпись")
                        chat_btn_voice.setColorFilter(ContextCompat.getColor(APP_ACTIVITY,R.color.colorLightBlue))
